"""
Carvis - Comprehensive Turkish Automotive Market Generator
Includes 100% of Sahibinden.com & Arabam.com Turkish Market Brands, Series, Models & Engine Codes.
"""

import json

TURKISH_MARKET_DATABASE = [
    {
        "brand": "Alfa Romeo",
        "series": [
            {"name": "147", "models": [
            ...
            {"name": "156", "models": [
                ...
                {"name": "2.0 TS", "engine_code": "AR32310", "fuel": "Benzin", "trims": ["Distinctive", "Selespeed"]}
            ]},
            {"name": "159", "models": [
            ...
            {"name": "Giulia", "models": [
                {"name": "2.0 Q4", "engine_code": "55273835", "fuel": "Benzin", "trims": ["Veloce", "Sprint"]},
                {"name": "2.9 V6 Bi-Turbo", "engine_code": "670050436", "fuel": "Benzin", "trims": ["Quadrifoglio"]}
            ]},
            {"name": "Stelvio", "models": [
                {"name": "2.0 Q4", "engine_code": "55273835", "fuel": "Benzin", "trims": ["Veloce", "Sprint"]}
            ]},
            {"name": "Tonale", "models": [
                {"name": "1.5 MHEV", "engine_code": "46347813", "fuel": "Hibrit", "trims": ["Sprint", "Ti", "Veloce"]},
                {"name": "1.3 Plug-in Hybrid", "engine_code": "46347814", "fuel": "Hibrit", "trims": ["Veloce"]}
            ]}
        ]
    },
    {
    ...
    },
    {
        ...
        "series": [
            ...
            {"name": "DBX", "models": [{"name": "4.0 V8", "engine_code": "M177", "fuel": "Benzin", "trims": ["V8", "707"]}]},
    ...
    },
    {
        ...
        "series": [
            ...
            {"name": "A5", "models": [
                {"name": "40 TDI Quattro", "engine_code": "DETA", "fuel": "Dizel", "trims": ["Design", "Sport", "S Line"]},
                {"name": "45 TFSI Quattro", "engine_code": "DKNA", "fuel": "Benzin", "trims": ["S Line"]}
            ]},
            {"name": "A6", "models": [
                {"name": "2.0 TDI", "engine_code": "CAGB / CNHA", "fuel": "Dizel", "trims": ["Limousine", "Ultra"]},
                {"name": "40 TDI Quattro", "engine_code": "DFBA", "fuel": "Dizel", "trims": ["Design", "Sport"]},
            ...
            {"name": "Q7", "models": [{"name": "50 TDI Quattro", "engine_code": "DHXA", "fuel": "Dizel", "trims": ["S Line"]}]}
        ]
    },
    {
        "brand": "BMW",
        "series": [
            ...
            {"name": "3 Series", "models": [
                ...
                {"name": "320i ED / 320i", "engine_code": "N13B16A / N20B20A / B48B20A", "fuel": "Benzin", "trims": ["Modern", "Luxury", "M Sport", "First Edition"]},
                {"name": "320d", "engine_code": "N47D20C / B47D20A", "fuel": "Dizel", "trims": ["Comfort", "Luxury", "M Sport"]}
            ]},
            {"name": "4 Series", "models": [
                {"name": "420i Gran Coupe", "engine_code": "N20B20A / B48B20A", "fuel": "Benzin", "trims": ["Luxury", "M Sport"]},
                {"name": "430i Gran Coupe", "engine_code": "B48B20B", "fuel": "Benzin", "trims": ["M Sport"]}
            ]},
            {"name": "5 Series", "models": [
                {"name": "520i", "engine_code": "N20B20A / B48B20A", "fuel": "Benzin", "trims": ["Executive", "Luxury", "M Sport"]},
            ...
            {"name": "X5", "models": [{"name": "xDrive30d / xDrive40i", "engine_code": "B57D30A / B58B30A", "fuel": "Dizel", "trims": ["xLine", "M Sport"]}]}
        ]
    },
    {
        "brand": "BYD",
    ...
    },
    {
        ...
        "series": [
            ...
            {"name": "C3 Aircross", "models": [
                {"name": "1.2 PureTech", "engine_code": "EB2ADTS", "fuel": "Benzin", "trims": ["Feel Bold", "Shine"]},
                {"name": "1.5 BlueHDi", "engine_code": "DV5RD", "fuel": "Dizel", "trims": ["Shine"]}
            ]},
            {"name": "C4", "models": [
                {"name": "1.2 PureTech 130", "engine_code": "EB2ADTS", "fuel": "Benzin", "trims": ["Feel", "Feel Bold", "Shine", "Shine Bold"]},
                {"name": "1.5 BlueHDi 130", "engine_code": "DV5RD", "fuel": "Dizel", "trims": ["Shine Bold"]},
            ...
            {"name": "C5 Aircross", "models": [
                {"name": "1.5 BlueHDi 130", "engine_code": "DV5RD", "fuel": "Dizel", "trims": ["Feel Bold", "Shine", "Shine Bold"]},
                {"name": "1.6 PureTech 180", "engine_code": "EP6FADTX", "fuel": "Benzin", "trims": ["Shine Bold"]}
            ]},
            {"name": "Berlingo", "models": [
                {"name": "1.6 HDi / 1.5 BlueHDi", "engine_code": "DV6ATED4 / DV5RD", "fuel": "Dizel", "trims": ["Multispace", "Feel", "Shine"]}
            ]},
            {"name": "Nemo", "models": [
                {"name": "1.4 HDi / 1.3 HDi", "engine_code": "DV4TD / 199A2000", "fuel": "Dizel", "trims": ["Combi", "XTR"]}
            ]}
        ]
    },
    {
        ...
        "series": [
            {"name": "Formentor", "models": [
                {"name": "1.5 TSI 150", "engine_code": "DADA / DPCA", "fuel": "Benzin", "trims": ["Base", "VZ"]},
                {"name": "2.0 TSI 310 VZ5", "engine_code": "DNUE", "fuel": "Benzin", "trims": ["VZ5"]}
            ]},
            {"name": "Leon", "models": [{"name": "1.5 eTSI 150", "engine_code": "DFYA", "fuel": "Hibrit", "trims": ["Base"]}]},
    ...
    },
    {
        ...
        "series": [
            {"name": "Duster", "models": [
                {"name": "1.5 dCi", "engine_code": "K9K 658 / K9K 872", "fuel": "Dizel", "trims": ["Ambiance", "Laureate", "Prestige", "Comfort"]},
                {"name": "1.3 TCe 150", "engine_code": "H5H 470", "fuel": "Benzin", "trims": ["Prestige", "Journey"]},
                {"name": "1.0 ECO-G", "engine_code": "H4D 470", "fuel": "LPG", "trims": ["Comfort", "Prestige"]}
            ]},
            ...
            {"name": "Logan", "models": [
                {"name": "1.5 dCi", "engine_code": "K9K 792", "fuel": "Dizel", "trims": ["Ambiance", "Laureate"]},
                {"name": "1.4 / 1.6", "engine_code": "K7J 710", "fuel": "LPG", "trims": ["Ambiance"]}
            ]},
            {"name": "Lodgy", "models": [{"name": "1.5 dCi", "engine_code": "K9K 658", "fuel": "Dizel", "trims": ["Laureate", "Stepway"]}]},
    ...
    },
    {
        ...
        "series": [
            {"name": "Egea", "models": [
                {"name": "1.3 Multijet 95hp", "engine_code": "199B1000", "fuel": "Dizel", "trims": ["Easy", "Urban", "Lounge", "Mirror", "Street"]},
                {"name": "1.4 Fire 95hp", "engine_code": "843A1000", "fuel": "Benzin", "trims": ["Easy", "Urban", "Lounge", "Street"]},
                {"name": "1.6 Multijet 120hp / DCT", "engine_code": "55260384", "fuel": "Dizel", "trims": ["Urban", "Lounge", "S-Design"]},
                {"name": "1.5 Hybrid 130hp", "engine_code": "46347813 GSH", "fuel": "Hibrit", "trims": ["Urban", "Lounge", "Cross"]},
                {"name": "Cross / Cross Express", "engine_code": "199B1000 / 55260384", "fuel": "Dizel", "trims": ["Street", "Urban", "Lounge"]}
            ]},
            {"name": "Linea", "models": [
            ...
            {"name": "Punto / Grande Punto", "models": [
                {"name": "1.3 Multijet", "engine_code": "199A2000", "fuel": "Dizel", "trims": ["Active", "Dynamic", "Pop", "Lounge"]},
                {"name": "1.4 Fire", "engine_code": "350A1000", "fuel": "LPG", "trims": ["Active", "Pop"]}
            ]},
            {"name": "Uno", "models": [{"name": "70 S / 60 S", "engine_code": "160 A1.000", "fuel": "LPG", "trims": ["S", "SX"]}]},
            {"name": "Tempra", "models": [{"name": "1.6 i.e. SX", "engine_code": "159 A3.000", "fuel": "LPG", "trims": ["SX", "SX A Klima"]}]},
            {"name": "Palio", "models": [
                {"name": "1.2 8V / 16V", "engine_code": "178 A4.000", "fuel": "LPG", "trims": ["EL", "SL"]},
                {"name": "1.3 Multijet", "engine_code": "188 A9.000", "fuel": "Dizel", "trims": ["Dynamic", "Sole"]}
            ]},
            {"name": "Albea", "models": [
                {"name": "1.3 Multijet", "engine_code": "188 A9.000", "fuel": "Dizel", "trims": ["Sole", "Dynamic"]},
                {"name": "1.4 Fire", "engine_code": "350A1000", "fuel": "LPG", "trims": ["Sole"]}
            ]},
    ...
    },
    {
        ...
        "series": [
            {"name": "Focus", "models": [
                ...
                {"name": "1.0 EcoBoost", "engine_code": "M1DA / M2DA", "fuel": "Benzin", "trims": ["Style", "Titanium"]}
            ]},
            {"name": "Fiesta", "models": [
                {"name": "1.4 TDCi", "engine_code": "F6JB", "fuel": "Dizel", "trims": ["Comfort", "Titanium"]},
                {"name": "1.25 / 1.4", "engine_code": "SNJA", "fuel": "LPG", "trims": ["MyFiesta", "Titanium"]},
                {"name": "1.0 EcoBoost", "engine_code": "B7DA", "fuel": "Benzin", "trims": ["Titanium", "ST Line"]}
            ]},
            {"name": "Courier", "models": [
                {"name": "1.5 TDCi 75hp / 95hp", "engine_code": "UGCA / XVCA", "fuel": "Dizel", "trims": ["Trend", "Deluxe", "Titanium", "Black Line"]},
                {"name": "1.6 TDCi", "engine_code": "T1DB", "fuel": "Dizel", "trims": ["Trend", "Titanium"]}
            ]},
            {"name": "Transit Connect", "models": [
                {"name": "1.8 TDCi 75 / 90 / 110hp", "engine_code": "BHPA / HCPA / RWPA", "fuel": "Dizel", "trims": ["Kombi", "GLX", "Silver", "Black"]},
                {"name": "1.5 TDCi", "engine_code": "XWDA", "fuel": "Dizel", "trims": ["Trend", "Titanium"]}
            ]},
            {"name": "Transit / Custom", "models": [
                {"name": "2.0 EcoBlue", "engine_code": "YNF6 / YLF6 / BKFA", "fuel": "Dizel", "trims": ["330S", "350L", "Tourneo Custom", "Trend", "Titanium"]},
                {"name": "2.2 TDCi", "engine_code": "CYFA / DRFA", "fuel": "Dizel", "trims": ["330M", "350L"]}
            ]},
            {"name": "Mondeo", "models": [{"name": "2.0 TDCi / 1.5 EcoBoost", "engine_code": "T8CC / M1CA", "fuel": "Dizel", "trims": ["Style", "Titanium"]}]},
            {"name": "Kuga", "models": [{"name": "1.5 TDCi / 1.5 EcoBoost", "engine_code": "XWDA / M8MA", "fuel": "Dizel", "trims": ["Trend X", "Titanium", "ST Line"]}]},
    ...
    },
    {
        ...
        "series": [
            ...
            {"name": "Jazz", "models": [{"name": "1.4 i-DSI / 1.3 i-VTEC", "engine_code": "L13A / L13B", "fuel": "Benzin", "trims": ["Joy", "Fun"]}]}
        ]
    },
    {
        "brand": "Hyundai",
        "series": [
            ...
            {"name": "i30", "models": [{"name": "1.6 CRDi 136hp", "engine_code": "D4FB", "fuel": "Dizel", "trims": ["Style", "Elite"]}]},
            {"name": "Tucson", "models": [
            ...
            {"name": "Elantra", "models": [{"name": "1.6 MPi 127hp / 1.6 CRDi", "engine_code": "G4FG / D4FB", "fuel": "Benzin", "trims": ["Style", "Elite"]}]},
            {"name": "Bayon", "models": [{"name": "1.4 MPi / 1.0 T-GDi", "engine_code": "G4LC / G3LC", "fuel": "Benzin", "trims": ["Jump", "Style", "Elite"]}]}
        ]
    },
    {
        "brand": "Kia",
        "series": [
            {"name": "Sportage", "models": [
                {"name": "1.6 CRDi 136hp", "engine_code": "D4FE", "fuel": "Dizel", "trims": ["Cool", "Elegance", "Prestige"]},
                {"name": "1.6 GDI / T-GDI", "engine_code": "G4FD / G4FJ", "fuel": "Benzin", "trims": ["Comfort", "Elegance"]}
            ]},
            {"name": "Ceed", "models": [{"name": "1.6 CRDi 136hp", "engine_code": "D4FB", "fuel": "Dizel", "trims": ["Cool", "Concept Plus"]}]},
            {"name": "Rio", "models": [{"name": "1.4 CRDi / 1.2 CVVT", "engine_code": "D4FC / G4LA", "fuel": "Dizel", "trims": ["Fun", "Concept"]}]},
            {"name": "Stonic", "models": [{"name": "1.4 DPI / 1.0 T-GDI", "engine_code": "G4LC / G3LC", "fuel": "Benzin", "trims": ["Cool", "Elegance"]}]}
        ]
    },
    {
        "brand": "Lada",
    ...
    },
    {
        ...
        "series": [
            ...
            {"name": "C-Class", "models": [
                {"name": "C 180 (1.6t / 1.5t)", "engine_code": "M 274.910 / M 264.915", "fuel": "Benzin", "trims": ["Fascination", "AMG", "Exclusive"]},
                {"name": "C 200 d (1.6d / 2.0d)", "engine_code": "OM 626 / OM 654", "fuel": "Dizel", "trims": ["Comfort", "AMG"]},
                {"name": "C 220 d", "engine_code": "OM 651 / OM 654", "fuel": "Dizel", "trims": ["AMG"]}
            ]},
            {"name": "E-Class", "models": [
                {"name": "E 220 d 194hp", "engine_code": "OM 654.920", "fuel": "Dizel", "trims": ["Avantgarde", "Exclusive", "AMG"]},
            ...
            {"name": "GLA / GLC", "models": [{"name": "GLA 200 / GLC 220 d", "engine_code": "M 282 / OM 654", "fuel": "Dizel", "trims": ["Off-Road", "AMG"]}]},
            {"name": "Vito / Sprinter", "models": [{"name": "111 CDI / 114 CDI / 316 CDI", "engine_code": "OM 622 / OM 651", "fuel": "Dizel", "trims": ["Tourer", "Panelvan"]}]}
        ]
    },
    {
        "brand": "Mini",
        "series": [
            {"name": "Cooper", "models": [{"name": "1.5 136hp / 1.5D", "engine_code": "B38A15A / B37C15", "fuel": "Benzin", "trims": ["Chili", "Pepper"]}]},
    ...
    },
    {
        ...
        "series": [
            {"name": "Qashqai", "models": [
                ...
                {"name": "1.3 DIG-T 158hp", "engine_code": "HR13DDT", "fuel": "Benzin", "trims": ["Tekna", "Sky Pack", "Platinum Premium"]},
            ...
            {"name": "Micra", "models": [{"name": "1.2 / 0.9 IG-T / 1.0", "engine_code": "HR12DE / HR09DET", "fuel": "Benzin", "trims": ["Match", "Tekna"]}]},
            {"name": "Navara", "models": [{"name": "2.3 dCi 160hp / 190hp", "engine_code": "YS23DDT", "fuel": "Dizel", "trims": ["SE", "LE", "Platinum"]}]}
        ]
    },
    {
        "brand": "Opel",
        "series": [
            ...
            {"name": "Corsa", "models": [
                ...
                {"name": "1.2 Twinport / 1.4", "engine_code": "A12XER / A14XER", "fuel": "LPG", "trims": ["Essentia", "Enjoy"]},
            ...
            {"name": "Crossland", "models": [{"name": "1.2 Turbo / 1.5 D", "engine_code": "EB2ADTS / DV5RD", "fuel": "Dizel", "trims": ["Essential", "Edition"]}]},
            {"name": "Combo", "models": [{"name": "1.5 CDTI 102hp / 130hp", "engine_code": "DV5RD", "fuel": "Dizel", "trims": ["Edition", "Ultimate"]}]}
        ]
    },
    {
        "brand": "Peugeot",
        "series": [
            {"name": "206", "models": [
                {"name": "1.4 HDi 70hp", "engine_code": "DV4TD", "fuel": "Dizel", "trims": ["XR", "XT", "X-Line", "Desire"]},
                {"name": "1.4 75hp", "engine_code": "TU3JP", "fuel": "LPG", "trims": ["XR", "XT"]},
                {"name": "206+ 1.4 HDi", "engine_code": "DV4TD", "fuel": "Dizel", "trims": ["Comfort", "Urban"]}
            ]},
            {"name": "207", "models": [
                ...
                {"name": "1.4 75hp / 1.4 VTi", "engine_code": "TU3JP / EP3", "fuel": "LPG", "trims": ["Trendy", "Comfort"]}
            ]},
            {"name": "208", "models": [
                {"name": "1.2 PureTech 75 / 100 / 130hp", "engine_code": "EB2F / EB2ADTS", "fuel": "Benzin", "trims": ["Active", "Allure", "GT"]},
                {"name": "1.4 HDi / 1.5 BlueHDi", "engine_code": "DV4TD / DV5RD", "fuel": "Dizel", "trims": ["Active", "Allure"]},
            ...
            {"name": "301", "models": [
                ...
                {"name": "1.2 VTi", "engine_code": "EB2M", "fuel": "Benzin", "trims": ["Active"]}
            ]},
            {"name": "307", "models": [
            ...
            {"name": "308", "models": [
                ...
                {"name": "1.2 PureTech 130hp", "engine_code": "EB2ADTS", "fuel": "Benzin", "trims": ["Active", "Allure", "GT"]},
                {"name": "1.6 e-HDi 115hp", "engine_code": "DV6C", "fuel": "Dizel", "trims": ["Access", "Active", "Allure"]}
            ]},
            {"name": "407", "models": [
                {"name": "1.6 HDi 110hp", "engine_code": "DV6TED4", "fuel": "Dizel", "trims": ["Comfort", "Executive"]}
            ]},
            {"name": "508", "models": [
                {"name": "1.5 BlueHDi 130hp / 1.6 PureTech", "engine_code": "DV5RD / EP6FADTX", "fuel": "Dizel", "trims": ["Prime", "Allure", "GT Line", "GT"]}
            ]},
            {"name": "2008", "models": [
    ...
    },
    {
        ...
        "series": [
            ...
            {"name": "Panamera", "models": [{"name": "2.9 V6 4 E-Hybrid", "engine_code": "DGG", "fuel": "Hibrit", "trims": ["4S", "Executive"]}]},
    ...
    },
    {
        ...
        "series": [
            ...
            {"name": "Captur / Austral", "models": [{"name": "1.3 TCe Mild Hybrid 160hp", "engine_code": "H5H 470", "fuel": "Hibrit", "trims": ["Techno", "Esprit Alpine"]}]},
            {"name": "Kadjar", "models": [{"name": "1.5 dCi / 1.3 TCe", "engine_code": "K9K 872 / H5H", "fuel": "Dizel", "trims": ["Touch", "Icon"]}]},
            {"name": "Toros / R12", "models": [{"name": "1.4 SW", "engine_code": "C1J", "fuel": "LPG", "trims": ["Standart"]}]}
        ]
    },
    {
        "brand": "SEAT",
        "series": [
            ...
            {"name": "Arona", "models": [{"name": "1.0 TSI 110hp", "engine_code": "DKRF", "fuel": "Benzin", "trims": ["Style", "FR"]}]},
            {"name": "Ateca", "models": [{"name": "1.6 TDI / 1.5 TSI 150hp", "engine_code": "DGTE / DPCA", "fuel": "Benzin", "trims": ["Experience", "FR"]}]}
        ]
    },
    {
        "brand": "Skoda",
        "series": [
            ...
            {"name": "Fabia", "models": [{"name": "1.2 TSI / 1.0 TSI", "engine_code": "CJZC / CHZB", "fuel": "Benzin", "trims": ["Ambition", "Style"]}]},
            {"name": "Kamiq / Karoq / Kodiaq", "models": [
                {"name": "1.5 TSI 150hp DSG", "engine_code": "DPCA", "fuel": "Benzin", "trims": ["Elite", "Premium", "Prestige"]}
            ]}
        ]
    },
    {
    ...
    },
    {
        ...
        "series": [
            ...
            {"name": "Kartal", "models": [
                {"name": "1.6 SLX ie", "engine_code": "159 A3.000", "fuel": "LPG", "trims": ["SLX ie", "SLX", "S"]}
            ]},
            {"name": "Murat 131 / 124", "models": [{"name": "1.3 / 1.2", "engine_code": "131 A.000", "fuel": "LPG", "trims": ["Standart"]}]}
        ]
    },
    {
        "brand": "Togg",
        "series": [
            ...
            {"name": "T10F", "models": [
                {"name": "Fastback RWD Uzun Menzil", "engine_code": "Bosch e-Motor 160kW", "fuel": "Elektrik", "trims": ["V2 Uzun Menzil"]}
            ]}
        ]
    },
    {
        ...
        "series": [
            ...
            {"name": "C-HR", "models": [{"name": "1.8 Hybrid 122hp / 140hp", "engine_code": "2ZR-FXE", "fuel": "Hibrit", "trims": ["Flame", "Passion", "GR Sport"]}]},
            {"name": "Auris", "models": [{"name": "1.4 D-4D / 1.6", "engine_code": "1ND-TV / 1ZR-FAE", "fuel": "Dizel", "trims": ["Active", "Touch", "Premium"]}]},
            {"name": "Hilux", "models": [{"name": "2.4 D-4D 150hp 4x4", "engine_code": "2GD-FTV", "fuel": "Dizel", "trims": ["Comfort", "Adventure", "Invincible"]}]}
        ]
    },
    {
        "brand": "Volkswagen",
        "series": [
            ...
            {"name": "Passat", "models": [
                ...
                {"name": "2.0 TDI 150hp / 190hp 4Motion", "engine_code": "CBAB / CFFB / DFHA", "fuel": "Dizel", "trims": ["Comfortline", "Highline", "Elegance"]},
            ...
            {"name": "Jetta", "models": [
                ...
                {"name": "1.2 TSI / 1.4 TSI", "engine_code": "CBZA / CAXA", "fuel": "Benzin", "trims": ["Trendline", "Comfortline"]}
            ]},
            {"name": "Tiguan", "models": [
                ...
                {"name": "1.4 TSI 150hp ACT", "engine_code": "CZEA", "fuel": "Benzin", "trims": ["Trendline", "Highline"]}
            ]},
            {"name": "Caddy", "models": [
            ...
            {"name": "Transporter / Caravelle", "models": [
                {"name": "2.0 TDI 102hp / 140hp / 180hp BiTDI", "engine_code": "CAAA / CCHA / CFCA", "fuel": "Dizel", "trims": ["City Van", "Kombi", "Caravelle Highline"]}
            ]},
            {"name": "Scirocco", "models": [{"name": "1.4 TSI 122 / 160hp", "engine_code": "CAXA / CAVD", "fuel": "Benzin", "trims": ["Sportline"]}]},
            {"name": "Arteon", "models": [{"name": "2.0 TDI 240hp 4Motion / 1.5 TSI", "engine_code": "CUAA / DPCA", "fuel": "Dizel", "trims": ["Elegance", "R-Line"]}]}
        ]
    },
    {
        "brand": "Volvo",
        "series": [
            {"name": "S40", "models": [{"name": "1.6 D 109hp", "engine_code": "D4164T", "fuel": "Dizel", "trims": ["Base", "Premium"]}]},
            {"name": "S60", "models": [
            ...
            {"name": "S90", "models": [{"name": "2.0 D5 AWD 235hp", "engine_code": "D4204T23", "fuel": "Dizel", "trims": ["Inscription"]}]},
            {"name": "XC60", "models": [{"name": "2.0 D4 / B5 AWD", "engine_code": "D4204T14", "fuel": "Hibrit", "trims": ["Inscription", "R-Design"]}]},
            {"name": "XC90", "models": [{"name": "2.0 D5 AWD 235hp", "engine_code": "D4204T23", "fuel": "Dizel", "trims": ["Inscription"]}]}
        ]
    }
]
...
def main():
    print("=" * 60)
    print("CARVIS - EXHAUSTIVE TURKISH AUTOMOTIVE MARKET GENERATOR")
    print("Source: Sahibinden.com & Arabam.com Master Database")
    print("=" * 60)

    # Sort alphabetically by brand name
    car_database = sorted(TURKISH_MARKET_DATABASE, key=lambda x: x["brand"].lower())
