...
const AuthLoginModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/80 z-[9999] flex items-center justify-center p-4 overflow-y-auto animate-fade-in">
      ...
      <div className="w-full max-w-[420px] bg-white dark:bg-[#080d1a] border border-slate-200 dark:border-white/10 rounded-xl p-7 sm:p-9 relative overflow-hidden text-slate-900 dark:text-white my-auto">
