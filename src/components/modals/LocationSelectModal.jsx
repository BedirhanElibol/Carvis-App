      ...
      <div className="bg-slate-900 w-full sm:w-[450px] p-8 rounded-t-[3rem] sm:rounded-[3rem] border-t sm:border border-white/10 animate-in slide-in-from-bottom-full duration-500 shadow-[0_20px_100px_rgba(0,0,0,0.8)] relative overflow-hidden">
        ...
        <div className="bg-slate-950/40 border border-white/5 p-4 rounded-2xl mb-8 flex items-center gap-3 relative z-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm font-bold text-white leading-none font-sans">
        ...
        <div className="space-y-5 relative z-10">
          ...
          >
            ...
            <div className="text-left">
              <h4 className="font-black text-white text-sm uppercase tracking-tight font-sans">
                {t.currentLocation}
              </h4>
          ...
          <div className="relative">
            <button
              ...
              className={`w-full bg-white/5 border p-5 rounded-3xl flex items-center justify-between transition-all active-scale ${
                isManual
              ...
              <div className="space-y-4 pt-6 animate-in slide-in-from-top-2 duration-300">
                <div className="relative group">
                  <select
                    ...
                    className="w-full bg-slate-950 border border-white/10 rounded-2xl p-4 outline-none text-sm font-bold text-white focus:ring-2 focus:ring-primary-500 transition-all appearance-none cursor-pointer font-sans"
                  >
                    <option
                      value=""
                      disabled
                ...
                <button
                  ...
                  className="w-full bg-primary-600 hover:bg-primary-500 text-white py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all active-scale shadow-lg shadow-primary-900/20 flex items-center justify-center gap-3 mt-4 font-sans"
                >
