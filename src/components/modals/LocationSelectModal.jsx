...
const LocationSelectModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-50 dark:bg-slate-950/60 z-[200] flex items-end sm:items-center justify-center animate-in fade-in duration-300">
      <div className="bg-white dark:bg-slate-900 w-full sm:w-[450px] p-8 rounded-t-[3rem] sm:rounded-[3rem] border-t sm:border border-black/10 dark:border-white/10 animate-in slide-in-from-bottom-full duration-500 relative overflow-hidden">
        {/* Background Glow */}
        ...
        <div className="space-y-5 relative z-10">
          <button
            ...
            className="w-full bg-gradient-to-r from-primary-600/20 to-primary-900/10 border border-primary-500/20 p-5 rounded-xl flex items-center gap-5 hover:bg-primary-500/20 transition-all group active-scale shadow-lg"
          >
            <div className="bg-primary-500 p-3.5 rounded-2xl group-hover:scale-[1.02] transition-transform">
          ...
          <div className="relative">
            <button
              ...
              className={`w-full bg-black/5 dark:bg-white/5 border p-5 rounded-xl flex items-center justify-between transition-all active-scale ${
                isManual
