      ...
      <div className="bg-white dark:bg-slate-900 w-full max-w-xl rounded-t-[2.5rem] sm:rounded-[3rem] border border-black/10 dark:border-white/10 shadow-xl overflow-hidden relative animate-in slide-in-from-bottom-full sm:slide-in-from-bottom-0 sm:zoom-in-95 duration-300 pb-safe max-h-[90vh] flex flex-col">
        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 p-6 flex items-center justify-between border-b border-black/5 dark:border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest mt-0.5 font-sans">
        ...
        <div className="px-8 pt-6 pb-2">
          <div className="flex justify-between relative">
            ...
            {/* Connecting Line */}
            <div className="absolute top-5 left-0 w-full h-0.5 bg-black/5 dark:bg-white/5 -z-0"></div>
            <div
            ...
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
              <div className="bg-primary-500/5 border border-primary-500/20 p-4 rounded-3xl flex items-start gap-4">
                ...
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed font-sans">
                  <span className="font-bold text-slate-900 dark:text-white uppercase block mb-1">
                    UNUTMAYIN
                  </span>
              ...
              <button className="w-full aspect-video bg-black/5 dark:bg-white/5 border-2 border-dashed border-black/10 dark:border-white/10 rounded-[2.5rem] flex flex-col items-center justify-center gap-4 hover:border-primary-500/40 hover:bg-primary-500/5 transition-all active-scale group">
                ...
                <span className="text-xs font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest font-sans">
          ...
          {step === 2 && (
            <div className="space-y-4 animate-in slide-in-from-right-4 duration-500">
              <div className="space-y-1.5">
                ...
                <input
                  className="w-full bg-slate-100 dark:bg-slate-800 border border-black/5 dark:border-white/5 p-4 rounded-2xl text-sm outline-none focus:border-primary-500/50 transition-all font-mono"
          ...
          {step === 3 && (
            <div className="flex flex-col items-center justify-center py-10 space-y-6 animate-in slide-in-from-right-4 duration-500">
              ...
              <div className="text-center">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white uppercase tracking-tighter mb-2 font-sans">
                  Hasar Analizi Başlatılıyor
                </h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 max-w-[250px] mx-auto leading-relaxed font-sans">
          ...
          {step === 4 && (
            <div className="space-y-6 animate-in zoom-in-95 duration-500">
              <div className="text-center">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 uppercase tracking-widest font-bold font-sans">
                  Kaza Raporunuz Dijital Olarak Oluşturuldu
                </p>
              </div>
              <div className="bg-black/5 dark:bg-white/5 rounded-[2rem] p-5 space-y-4 border border-black/5 dark:border-white/5">
                <div className="flex justify-between items-center text-sm font-bold font-sans">
                  ...
                  <span className="text-slate-900 dark:text-white">Maddi Hasarlı</span>
                </div>
                <div className="flex justify-between items-center text-sm font-bold font-sans">
                  <span className="text-slate-500 uppercase text-[10px] tracking-widest">
                    Tahmini Hasar:
        ...
        {/* Footer Navigation */}
        {step < 4 && (
          <div className="p-6 bg-slate-50 dark:bg-slate-950/50 border-t border-black/5 dark:border-white/5 flex gap-4 shrink-0">
            {step > 1 && (
              <button
                onClick={prevStep}
