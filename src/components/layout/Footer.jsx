...
const Footer = () => {
  ...
  return (
    <footer className="mt-12 mb-24 px-6 pb-12 border-t border-white/5 pt-12 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="grid grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-4">
              <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest font-sans">Kurumsal</h4>
            ...
            <div className="space-y-4">
              <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest font-sans">Legal</h4>
              <ul className="space-y-2">
