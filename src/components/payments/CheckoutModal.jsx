...
export default function CheckoutModal({ isOpen, onClose, amount, providerName, onPaymentSuccess }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-[#030712] border border-white/10 rounded-2xl shadow-[0_0_40px_rgba(16,185,129,0.15)] w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-300">
                {/* Header */}
                <div className="relative bg-gradient-to-r from-primary/20 to-accent/20 p-6 text-center border-b border-white/10">
                    ...
                    <div className="mx-auto w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center mb-3 shadow-[0_0_15px_rgba(16,185,129,0.3)]">
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button 
                            ...
                            className="w-full mt-6 bg-gradient-to-r from-primary to-emerald-500 hover:from-primary/90 hover:to-emerald-500/90 text-white font-black uppercase tracking-wider py-4 rounded-xl shadow-[0_0_20px_rgba(16,185,129,0.3)] transition-all flex items-center justify-center gap-2 active-scale disabled:opacity-70"
                        >
                            {isProcessing ? (
                                <>
