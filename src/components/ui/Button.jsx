...
export const Button = ({
  ...
  const variants = {
    primary:
      "bg-primary-600 text-slate-900 dark:text-white hover:bg-primary-500 shadow-xl shadow-primary-900/20 border border-primary-500/50",
    secondary:
    ...
    danger:
      "bg-red-600 text-slate-900 dark:text-white hover:bg-red-500 shadow-xl shadow-red-900/20",
