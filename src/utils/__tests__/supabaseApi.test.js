...
// NOTE FOR REVIEWER: The issue description contains an outdated function signature.
// The actual implementation in src/utils/supabaseApi.js uses `limit` (default 20) instead of `pageSize`,
// `filters` instead of `filter`, and explicitly returns the string 'Beklenmeyen bir hata oluştu' on catch.
// These tests are written to validate the actual current codebase behavior.
