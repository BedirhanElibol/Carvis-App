  ...
  return (
    <div className="glass-card p-5 rounded-2xl border border-white/5 relative overflow-hidden group">
      ...
      <div className="relative z-10 flex justify-between items-start">
        <div>
          <h3 className="text-3xl font-black text-white font-sans uppercase">
            {weather.temp}°C
          </h3>
          <p className="text-sm font-bold text-slate-300 flex items-center gap-1 font-sans">
            <Icons.MapPin size={12} /> {selectedLocation.split(",")[0]}
          </p>
        </div>
        <div className="text-right">
          <p className="text-xs font-black text-white uppercase tracking-widest bg-white/10 px-2 py-1 rounded-lg backdrop-blur-md inline-block font-sans">
            {weather.condition}
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 flex gap-4 text-xs font-medium text-slate-300">
        ...
        <div className="flex items-center gap-1 font-sans">
          <Icons.Wind size={12} className="text-slate-400" /> {weather.wind}{" "}
          km/s
        </div>
      </div>
    </div>
