    ...
    return (
        <div className="glass-card p-4 rounded-2xl border border-white/5 flex items-center justify-between gap-4">
            <div className="flex items-center gap-2">
                ...
                <div>
                    <p className="text-[10px] text-slate-500 font-black uppercase">USD/TRY</p>
                    <p className="text-white font-bold">{rates.usd ? `₺${rates.usd.rate.toFixed(2)}` : '...'}</p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-2">
                ...
                <div>
                    <p className="text-[10px] text-slate-500 font-black uppercase">EUR/TRY</p>
                    <p className="text-white font-bold">{rates.eur ? `₺${rates.eur.rate.toFixed(2)}` : '...'}</p>
                </div>
            </div>
        </div>
    );
