          ...
          >
            ...
            <div className="p-8 space-y-8">
              {section.items.map((item, i) => (
                <div
                  key={i}
                  className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 last:pb-0 border-b last:border-0 border-black/5 dark:border-white/5"
                >
                  ...
                  <div className="flex items-center">
                    {item.type === "toggle" ? (
                      <button
                        ...
                        className={`w-14 h-8 rounded-full relative transition-colors ${item.value ? "bg-emerald-500" : "bg-slate-100 dark:bg-slate-800"}`}
                      >
                        <div
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="bg-white dark:bg-slate-900 border border-black/10 dark:border-white/10 rounded-xl px-4 py-2 text-slate-900 dark:text-white font-black text-center w-24 focus:border-red-500/50 focus:outline-none font-sans"
                        />
                      ...
                      <div className="w-full md:w-64">
                         ...
                         <input
                          ...
                          value={item.value}
                          onChange={(e) => item.onChange(e.target.value)}
                          className="bg-white dark:bg-slate-900 border border-black/10 dark:border-white/10 rounded-xl px-6 py-2.5 text-slate-900 dark:text-white font-medium focus:border-red-500/50 focus:outline-none w-full font-sans"
                        />
                      </div>
                    )}
                  </div>
