  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h2 className="text-lg font-black text-white uppercase tracking-tight">Vale Hizmet Bilgileri</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <label className="space-y-2">
          ...
          <select
            ...
            className="w-full bg-slate-900/80 border border-white/10 rounded-2xl px-4 py-3 text-sm text-white outline-none font-sans appearance-none"
          >
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className={cn(
            ...
            valetData.insurance_verified ? "bg-blue-500/10 border-blue-500/20 text-blue-400" : "bg-slate-800/50 border-white/5 text-slate-500"
          )}>
            <div className="flex items-center gap-2">
      ...
      <label className="block space-y-2">
        ...
        <textarea
          ...
          className="w-full bg-slate-900/80 border border-white/10 rounded-3xl px-6 py-4 text-sm text-white outline-none min-h-[100px] font-sans resize-none"
        />
      </label>
    </div>
  );
