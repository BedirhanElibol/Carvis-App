  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h2 className="text-lg font-black text-white uppercase tracking-tight">Yedek Parça Mağaza Bilgileri</h2>
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all ${
                    isSelected ? "bg-emerald-500/10 border-emerald-500/40 text-emerald-400 shadow-lg shadow-emerald-900/10" : "bg-white/5 border-white/5 text-slate-500"
                  }`}
                >
                  {labels[day]}
                </button>
