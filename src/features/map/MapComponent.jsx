  ...
  return L.divIcon({
    ...
    html: `
      <div class="relative w-12 h-12 flex items-center justify-center animate-in zoom-in duration-500">
        <!-- Marker Shape -->
        <div class="absolute inset-0 ${style.bg} rounded-full rotate-45 border-2 border-black/20 dark:border-white/20"></div>
  ...
  return L.divIcon({
    ...
    html: `
      <div class="relative w-10 h-10 flex items-center justify-center ${pulse}">
        <div class="absolute inset-0 ${bgClass} rounded-full rotate-45 border border-white/20"></div>
