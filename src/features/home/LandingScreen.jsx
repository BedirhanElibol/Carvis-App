...
const LandingScreen = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#030712] text-white overflow-x-hidden font-sans relative selection:bg-teal-500/30">
      ...
      <nav className="fixed top-4 left-4 right-4 z-50 max-w-7xl mx-auto">
        <div className="w-full bg-[#0a0f1d]/75 backdrop-blur-xl border border-white/10 px-4 md:px-8 py-3.5 rounded-[2rem] flex items-center justify-between shadow-2xl shadow-black/50">
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate("/")}>
            <img
              src={logo}
              alt="Rapidsy Logo"
              className="w-8 h-8 md:w-10 md:h-10 object-contain drop-shadow-[0_0_15px_rgba(20,184,166,0.3)] transition-transform duration-500 group-hover:rotate-12"
            />
            <span className="text-white text-lg md:text-xl font-black tracking-[0.15em] font-sans uppercase">
              RAPIDSY
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 active:scale-95 transition-all text-slate-400 hover:text-white"
            >
              <Icons.Globe size={18} />
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white/5 border border-white/10 text-xs font-bold text-slate-300 hover:text-white hover:bg-white/10 active:scale-95 transition-all"
            >
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-2xl bg-gradient-to-r from-teal-500 to-blue-600 hover:from-teal-400 hover:to-blue-500 text-xs font-black uppercase tracking-widest text-white shadow-lg shadow-teal-500/20 active:scale-95 transition-all"
            >
      ...
      <div className="relative z-10 pt-28 md:pt-36 flex flex-col items-center">
        ...
        <section className="w-full max-w-7xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <motion.p 
            ...
            className="text-slate-400 font-medium text-center max-w-2xl text-base md:text-xl tracking-tight leading-relaxed mb-8"
          >
          ...
          >
            <div className="bg-[#0a0f24]/90 backdrop-blur-2xl border border-white/10 rounded-3xl p-3 md:p-4 shadow-[0_0_40px_rgba(0,0,0,0.5)] flex flex-col md:flex-row gap-3 relative z-20">
              
              {/* Search Query Input */}
              <div className="flex-1 relative group">
                <Icons.Search className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-teal-400 transition-colors" size={20} />
                <input 
                  type="text" 
                  placeholder="Hangi hizmeti arıyorsunuz? (Örn: Periyodik Bakım)" 
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full bg-[#030712] border border-white/10 rounded-2xl py-4.5 pl-12 pr-4 text-sm font-bold text-white outline-none focus:ring-2 focus:ring-teal-500 transition-all placeholder:text-slate-500"
                />
              </div>

              {/* Location Selector */}
              <div className="w-full md:w-[240px] relative group">
                <Icons.MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-orange-400 transition-colors" size={20} />
                <select 
                  value={searchLocation}
                  onChange={(e) => setSearchLocation(e.target.value)}
                  className="w-full bg-[#030712] border border-white/10 rounded-2xl py-4.5 pl-12 pr-10 text-sm font-bold text-white outline-none focus:ring-2 focus:ring-orange-500 transition-all appearance-none cursor-pointer"
                >
              ...
              <button
                ...
                className="w-full md:w-auto px-8 py-4.5 rounded-2xl bg-gradient-to-r from-teal-500 to-blue-600 hover:from-teal-400 hover:to-blue-500 text-white font-black text-sm uppercase tracking-widest shadow-xl shadow-teal-500/20 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer border-none shrink-0 group"
              >
                HİZMET BUL
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 mt-6">
              ...
              {[
                ...
                <button 
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/20 transition-all cursor-pointer group"
                >
                  <cat.icon size={12} className={cat.color} />
                  <span className="text-[10px] md:text-xs font-bold text-slate-300 group-hover:text-white">{cat.name}</span>
                </button>
              ))}
            </div>
          </motion.div>
        ...
        <section className="w-full max-w-7xl mx-auto px-6 mb-24 relative">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white mt-2 tracking-tight uppercase">
              ÇEVRENİZDEKİ NOKTALAR
            </h2>
            <p className="text-slate-400 max-w-xl mx-auto mt-4 text-sm md:text-base leading-relaxed">
          ...
          <div className="flex flex-col lg:flex-row gap-6 h-[600px] w-full">
            ...
            <div className="w-full lg:w-[400px] flex flex-col gap-4 overflow-y-auto pr-2 custom-scrollbar">
              {[
                ...
                <div 
                  ...
                  onClick={() => openModal("login", "customer")}
                  className={`bg-[#0a0f24]/80 border ${hoveredPin === prov.id ? 'border-orange-500/50 bg-white/10' : 'border-white/5 hover:border-white/20'} p-5 rounded-3xl transition-all cursor-pointer group flex flex-col gap-3 shadow-xl backdrop-blur-md`}
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="text-white font-black uppercase tracking-tight text-sm group-hover:text-orange-400 transition-colors">{prov.name}</h4>
                      <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest block mt-1">{prov.type}</span>
                    </div>
                    <div className="flex items-center gap-1 text-[10px] font-bold text-slate-300 bg-white/5 px-2 py-1 rounded-lg border border-white/5">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <button className="text-[9px] font-black uppercase tracking-widest text-slate-400 group-hover:text-white flex items-center gap-1 transition-colors">
            ...
            <div className="flex-1 bg-[#050814] border border-white/10 rounded-[2.5rem] relative overflow-hidden shadow-2xl flex items-center justify-center p-4">
        ...
        <section className="w-full max-w-7xl mx-auto px-6 mb-28">
          <div className="bg-[#0a0f24]/60 border border-white/5 rounded-[3rem] p-10 md:p-16 space-y-12 relative overflow-hidden backdrop-blur-xl shadow-2xl">
            <div className="text-center max-w-2xl mx-auto">
              <span className="text-[10px] font-black uppercase tracking-[0.25em] text-teal-400">NASIL ÇALIŞIR?</span>
              <h3 className="text-3xl md:text-5xl font-black text-white mt-3 uppercase tracking-tight">3 Adımda Kolayca Yönetin</h3>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative mt-12">
              <div className="hidden md:block absolute top-10 left-[15%] right-[15%] h-0.5 bg-white/10 pointer-events-none z-0"></div>
              {[
                ...
                <div key={idx} className="flex flex-col items-center text-center relative z-10 group">
                  <div className={`w-20 h-20 rounded-[2rem] bg-gradient-to-br ${item.color} text-white flex items-center justify-center shadow-2xl group-hover:-translate-y-2 transition-transform duration-300 mb-6 border border-white/10`}>
                    <item.icon size={32} />
                  </div>
                  <div className="space-y-3">
                    <span className="inline-block px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[9px] font-mono font-black text-slate-300 tracking-widest uppercase">ADIM {item.step}</span>
                    <h4 className="text-lg font-black text-white uppercase tracking-tight">{item.title}</h4>
                    <p className="text-xs text-slate-400 leading-relaxed font-medium max-w-[260px] mx-auto">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="w-full max-w-7xl mx-auto px-6 mb-24">
          <div className="bg-gradient-to-r from-[#070b19] to-[#0a1024] border border-white/5 rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center relative z-10">
              <div className="space-y-1">
                <span className="text-3xl md:text-5xl font-black text-white bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-blue-500">
                  10k+
                </span>
                <p className="text-[10px] font-black text-slate-400 tracking-widest uppercase mt-2">Aktif Araç</p>
              </div>
              
              <div className="space-y-1">
                <span className="text-3xl md:text-5xl font-black text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-orange-400">
                  500+
                </span>
                <p className="text-[10px] font-black text-slate-400 tracking-widest uppercase mt-2">Onaylı Usta & Servis</p>
              </div>

              <div className="space-y-1">
                <span className="text-3xl md:text-5xl font-black text-white bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-rose-500">
                  %99.8
                </span>
                <p className="text-[10px] font-black text-slate-400 tracking-widest uppercase mt-2">Güvenli Ödeme</p>
              </div>

              <div className="space-y-1">
                <span className="text-3xl md:text-5xl font-black text-white bg-clip-text text-transparent bg-gradient-to-r from-rose-500 to-pink-500">
                  24/7
                </span>
                <p className="text-[10px] font-black text-slate-400 tracking-widest uppercase mt-2">Yapay Zeka Teşhisi</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="w-full max-w-7xl mx-auto px-6 mb-28 text-center relative">
          <div className="max-w-4xl mx-auto bg-gradient-to-b from-[#090e21] to-[#040713] border border-white/10 rounded-[3rem] p-10 md:p-16 relative overflow-hidden shadow-2xl">
            {/* Background elements */}
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <button
                onClick={() => navigate("/partner-login")}
                className="group px-8 py-4.5 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-400 hover:to-amber-500 text-white font-black text-sm uppercase tracking-widest shadow-xl shadow-orange-500/20 active:scale-95 transition-all flex items-center justify-center gap-2.5 cursor-pointer border-none"
              >
        ...
        {/* FOOTER */}
        <footer className="w-full border-t border-white/5 py-12 bg-[#02050c]">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <img src={logo} alt="Rapidsy Logo" className="w-8 h-8 object-contain" />
              <span className="text-white text-sm font-black tracking-widest uppercase">RAPIDSY © 2026</span>
            </div>
            
            <div className="flex items-center gap-6 text-xs text-slate-500 font-medium">
              <a href="/privacy-policy" className="hover:text-white transition-colors">Gizlilik Politikası</a>
              <span>•</span>
              <a href="#" onClick={(e) => { e.preventDefault(); openModal("kvkk"); }} className="hover:text-white transition-colors">KVKK Metni</a>
              <span>•</span>
