...
const MessageListScreen = () => {
  ...
  return (
    <div className="h-[calc(100vh-80px)] md:h-[calc(100vh-64px)] flex bg-slate-950 overflow-hidden relative">
      ...
      <div
        className={` w-full md:w-96 bg-slate-900/50 backdrop-blur-xl border-r border-white/5 flex flex-col z-10 transition-transform duration-300 absolute md:relative inset-0 ${
          mobileChatOpen
      ...
      >
        ...
        <div className="p-4 border-b border-white/5">
          <h1 className="text-xl font-black text-white tracking-tighter mb-4 flex items-center gap-2">
      ...
      {/* Chat Area */}
      <div
        className={` flex-1 z-20 absolute md:relative inset-0 w-full bg-slate-950 transition-transform duration-300 ${
