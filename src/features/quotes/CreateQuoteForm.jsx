...
import { ArrowLeft, DollarSign, Clock, Shield, FileText, Send } from 'lucide-react';
...
const CreateQuoteForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            showAlert('Hata', 'Teklif gönderilemedi. Lütfen tekrar deneyin.', 'error');
        } finally {
            setSubmitting(false);
        }
    };
                ...
                <div className="glass-card p-5 rounded-2xl border border-white/10">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="font-mono font-bold">{serviceRequest.plate}</span>
                        </div>
                        <div className="flex items-center justify-between">
                        ...
                        {serviceRequest.engine_code && (
                            <div className="flex items-center justify-between">
                                ...
                                <span className="font-semibold">{serviceRequest.engine_code}</span>
                            </div>
                        )}
                        <div className="flex items-center justify-between">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="glass-card p-5 rounded-2xl border border-white/10">
                        ...
                        <p className="text-xs text-slate-500 mt-2">
                            Ürün/hizmet detaylarını, marka bilgisini ve montaj durumunu belirtin.
                        </p>
                    </div>
                    ...
                    <div className="glass-card p-4 rounded-2xl border border-primary-500/30 bg-primary-500/5">
                        <p className="text-sm text-slate-300">
                            <span className="font-bold text-primary-400">💡 İpucu:</span> Detaylı ve net teklifler müşteriler tarafından daha çok tercih edilir.
                        </p>
                    </div>
